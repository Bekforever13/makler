...
const SelectInput = () => {
  ...
  const { data, isSuccess } = useGetSubcategoriesQuery({ category_id: filters.category_id })
  ...
  return (
    <Select label="Kategoriya saylan" value={subcategory_id} onChange={(e) => handleSelect(e)}>
      {data?.data?.map((el) => (
