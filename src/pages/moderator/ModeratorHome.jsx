        ...
        <div className=' flex flex-col justify-between gap-8 md:flex-row md:items-center'>
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center gap-5">
              <Typography className='mt-1 font-normal text-yellow-700'>
                В ожидании: <b className="text-black">{data?.totals?.waiting}</b>
              </Typography>
              <Typography className='mt-1 font-normal text-green-500'>
                Подтвержденные: <b className="text-black">{data?.totals?.confirmed}</b>
              </Typography>
              <Typography className='mt-1 font-normal text-red-500'>
                Отклоненные: <b className="text-black">{data?.totals?.canceled}</b>
              </Typography>
            </div>
          </div>
          <div className='flex w-full shrink-0 gap-2 md:w-max'>
            ...
            <Button
              className={
                active === "confirmed" ? "text-white" : "text-gray-900"
              }
              variant='gradient'
            ...
            <Button
              className={
                active === "cancelled" ? "text-white" : "text-gray-900"
              }
              variant='gradient'
